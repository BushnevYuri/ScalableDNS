...
#####  RUN sudo iptables -t nat -A POSTROUTING -o eth0 -j MASQUERADE         to get internet connection in openstack instances!!!!!

EXTERNAL_NETWORK_ID = '0028da9b-6933-4d4b-b83d-e0476be1e34c'
